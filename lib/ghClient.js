...
(function() {
  ...
  module.exports = function(conf) {
    var GH_DIR, TEMPLATE_DIR, c, get_authenticated_repo_url, get_github_team_name, gh_conf, git;
    gh_conf = conf.RESOURCES.GH;
    GH_DIR = __dirname;
    TEMPLATE_DIR = path.join(GH_DIR, './template_repo/');
